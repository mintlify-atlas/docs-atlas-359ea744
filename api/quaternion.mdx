...
`Quaternion` represents a 3D rotation as a unit quaternion with components **X, Y, Z** (vector part) and **W** (scalar part). It is the primary rotation primitive in Prowl.Vector — more numerically stable than Euler angles and free of gimbal lock.
