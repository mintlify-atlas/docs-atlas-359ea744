...
Three lightweight value types covering the most common geometric primitives. All three implement `IEquatable<T>` and `IFormattable`. `Sphere` additionally implements `IBoundingShape` for GJK support.
