...
var quat = Quaternion.CreateFromYawPitchRoll(0.3f, 0.1f, 0.0f);
...
Float3x3 axisRot = Float3x3.FromAxisAngle(axis, MathF.PI / 4f);

// 3. Elementary rotations and composition
Float3x3 rx = Float3x3.RotateX(MathF.PI / 6f);   // 30°
Float3x3 ry = Float3x3.RotateY(MathF.PI / 4f);   // 45°
