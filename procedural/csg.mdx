---
title: "Constructive Solid Geometry with GeometryCSG"
...
// Re-run CSG on a copy each frame (only if baseB has moved)
var copyA = CopyGeometry(baseA);
var copyB = CopyGeometry(baseB);
GeometryOperators.Translate(copyB, animatedOffset);

var result = GeometryCSG.Union(copyA, copyB);
```
