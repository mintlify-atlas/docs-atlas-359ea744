...
// Geometry and collision types — AABB, Sphere, Ray, Plane, GJK, Intersection, GeometryData …
using Prowl.Vector.Geometry;
```

**`Prowl.Vector`** exposes all the fundamental numeric types:
...
**`Prowl.Vector.Geometry`** exposes all spatial and collision types:
- Primitives: `AABB`, `Frustum`, `Plane`, `Ray`, `Sphere`, `Cone`, `Triangle`, `LineSegment`, `Spline`
- Transforms: `Transform2D`, `Transform3D`
- Mesh data: `GeometryData`
- Collision: `IBoundingShape`, `GJK`
