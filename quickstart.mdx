...
<Steps>
  ...
  <Step title="Import the Namespaces">
    ...
    using Prowl.Vector.Geometry; // Geometry types: AABB, Sphere, Ray, GJK, Intersection …
    ```
  </Step>
  ...
  <Step title="Run a Collision Check">
    ...
    // Direct ray-AABB test
    var ray = new Ray(new Double3(0, 5, 0), -Double3.UnitY);
